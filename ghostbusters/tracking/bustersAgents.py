...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        final_action, final_pos, final_dist = None, None, None
        for beliefs in livingGhostPositionDistributions:
            this_pos = beliefs.argMax()
            this_dist = self.distancer.getDistance(pacmanPosition, this_pos)
            if final_dist == None or this_dist < final_dist:
                final_dist = this_dist
                final_pos = this_pos

        for action in legal:
            this_pos = Actions.getSuccessor(pacmanPosition, action)
            this_dist = self.distancer.getDistance(this_pos, final_pos)
